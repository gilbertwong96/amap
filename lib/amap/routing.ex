defmodule Amap.Routing do
  ...
  # one generation's fields for both. The four names are the wire's, and each generation
  # builds its own struct from these values through that struct's `from_map/1` — the
  # boundary reach.check's same-entity rule asks for.
